...
const Profile = () => {
  ...
  const handleUpdate = async (id, updates) => {
    try {
      ...
      await axios.patch(`http://localhost:8080/api/apartment/${id}`, updates, {
        withCredentials: true,
      });
      setEditId(null);
      fetchApartments();
  ...
  const handleDelete = async (id) => {
    try {
      ...
      await axios.delete(`http://localhost:8080/api/apartment/${id}`, {
        withCredentials: true,
      });
            ...
            <tbody>
              {apartments.map((apartment) => (
                ...
                >
                  ...
                  >
                    <div
                      contentEditable={editId === apartment._id}
                      onBlur={(e) =>
                        handleUpdate(apartment._id, {
                  ...
                  <td className="px-6 py-4">
                    ...
                    <button
                      className="bg-gray-900 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full"
